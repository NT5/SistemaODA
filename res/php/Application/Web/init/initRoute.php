...
trait initRoute {
    ...
    private function initRoute() {
        ...
        $Route
                ...
                ->addRoute(new WebRoute('temas', Pages\Temas::class, $Ex))
                ->addRoute(new WebRoute('lecciones', Pages\Lecciones::class, $Ex))
                ->addRoute(new WebRoute('hendell', Pages\Hendell::class, $Ex))
